let
  ...
  vvh-nixos-vm = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEb/75yCQOiDvuAoRPEtC9L9T+QzvktxkSeC5qFuqFUI Valentín en NixOS-VM, Proxmox";
...
in
  ...
  "secrets/cloudflare-ddns.age".publicKeys = [ valentin vvh-nixos-vm nixosVm ];
  "secrets/cloudflare-acme.age".publicKeys = [ valentin vvh-nixos-vm nixosVm ];
